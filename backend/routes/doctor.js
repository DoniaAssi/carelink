  ...
  try {
    ...
    await db.query(
      `INSERT INTO appointmentstatushistory (statusHistoryId, requestId, patientUserId, providerUserId, statusCode, sourceRole, note)
       VALUES (?, ?, ?, ?, 'confirmed', 'doctor', 'Request accepted by doctor')`,
    ...
    try {
      await insertDoctorNotificationIfEnabled({
        ...
        body: 'You accepted a patient request. It is now confirmed in your schedule.',
      ...
      await insertNotification({
        ...
        body: 'Your doctor accepted the request. You can view the confirmed appointment in your schedule.',
        relatedRequestId: requestId,
      });
    } catch (_) {}
