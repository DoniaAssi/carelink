...
class PatientHeaderActions extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      mainAxisSize: MainAxisSize.min,
      children: [
        if (showLanguage) CarelinkLocaleIconButton(color: color),
        if (showTheme) CarelinkThemeIconButton(color: color),
      ],
    );
  }
}
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              if (showLanguage) CarelinkLocaleIconButton(color: primaryColor),
              if (showTheme) CarelinkThemeIconButton(color: primaryColor),
            ],
          ),
        ],
      ),
