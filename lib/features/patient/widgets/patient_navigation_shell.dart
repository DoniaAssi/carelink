...
class PatientNavigationShell extends StatefulWidget {
  ...
  static void switchTab(BuildContext context, int index) {
    final state = context.findAncestorStateOfType<_PatientNavigationShellState>();
    if (state != null) {
          ...
          child: BottomNavigationBar(
            ...
            items: [
              BottomNavigationBarItem(
                ...
                activeIcon: const Icon(Icons.home_rounded, size: 23, color: AppColors.primary),
                label: _t('Home', 'الرئيسية'),
              ),
              BottomNavigationBarItem(
                icon: const Icon(Icons.calendar_month_rounded, size: 23),
                activeIcon: const Icon(Icons.calendar_month_rounded, size: 23, color: AppColors.primary),
                label: _t('Bookings', 'حجوزاتي'),
              ),
              BottomNavigationBarItem(
                icon: const Icon(Icons.favorite_border_rounded, size: 23),
                activeIcon: const Icon(Icons.favorite_rounded, size: 23, color: AppColors.primary),
                label: _t('My care', 'رعايتي'),
              ),
              BottomNavigationBarItem(
                icon: const Icon(Icons.folder_outlined, size: 23),
                activeIcon: const Icon(Icons.folder_rounded, size: 23, color: AppColors.primary),
                label: _t('Records', 'السجل الطبي'),
              ),
              BottomNavigationBarItem(
                icon: const Icon(Icons.person_outline_rounded, size: 23),
                activeIcon: const Icon(Icons.person_rounded, size: 23, color: AppColors.primary),
