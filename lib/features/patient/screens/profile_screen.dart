...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget _buildTopSettings(CarelinkPalette p) {
    return Align(
      ...
      child: Row(
        ...
        children: [
          ...
          _topIconButton(
            ...
            onTap: () => handleItemTap('appearance'),
            p: p,
          ),
        ],
      ),
  ...
  Widget _topIconButton({
    ...
    return Tooltip(
      message: tooltip,
      child: Material(
        color: AppColors.primary.withValues(alpha: p.isDark ? 0.16 : 0.10),
