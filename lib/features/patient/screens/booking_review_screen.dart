  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: PatientAppBar(
        title: context.tr('booking.review.title'),
      ),
      body: ListView(
        ...
        children: [
          ...
          Text(
            '${_serviceLabel(r.serviceType)} · ${_appointmentTypeLabel(r.appointmentType)} · ${r.appointmentDate} · ${r.appointmentTime}',
        ...
        child: Padding(
          ...
          child: FilledButton(
            ...
            child: _isSubmitting
                ...
                : Text(context.tr('booking.review.continuePayment')),
          ),
        ),
      ),
    );
