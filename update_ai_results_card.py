...
class _AiProviderRecommendationCardState extends State<AiProviderRecommendationCard> with TickerProviderStateMixin {
  ...
  void _toggleExpand() {
    if (widget.highlighted) return; // Top recommendation is always expanded
    setState(() {
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(
                            widget.isArabic ? 'أفضل توصية للذكاء الاصطناعي' : 'AI Top Recommendation',
      ...
      children: [
        ...
        Wrap(
          ...
          children: [
            ...
            _buildInfoItem(Icons.circle, canBook ? Colors.green : Colors.orange, widget.isArabic ? (canBook ? 'متاح الآن' : 'مواعيد محدودة') : (canBook ? 'Available' : 'Limited')),
      ...
      children: [
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  const Icon(Icons.payments_rounded, color: Colors.green, size: 12),
                  const SizedBox(width: 2),
                  Text(
                    _price(provider),
                    style: TextStyle(color: scheme.onSurfaceVariant, fontSize: 11, fontWeight: FontWeight.bold),
        ...
        Column(
          ...
          children: [
            ...
            Text(
              widget.isArabic ? 'تطابق' : 'AI Match',
  ...
  Widget _buildReasonsList() {
    ...
    if (widget.result.recommendationReasons.isNotEmpty) {
      reasons.addAll(widget.result.recommendationReasons.take(5));
    } else {
        ...
        return Container(
          ...
          child: Row(
            ...
            children: [
              ...
              Text(
                r,
                style: TextStyle(color: Colors.green.shade800, fontSize: 11, fontWeight: FontWeight.w800),
              ),
            ],
          ),
        );
